...
public class Fruits : MonoBehaviour
{
    ...
    [SerializeField] private ParticleSystem _juiceExploParticles;
    [SerializeField] private ParticleSystem _juiceDrippingParticles;
    ...
    private void OnTriggerEnter(Collider other)
    {
        if (other.CompareTag("Grate"))
        {
            ...
            _juiceDrippingParticles.Play();
            _juiceExploParticles.Play();
        }
    }
    ...
    private void OnTriggerExit(Collider other)
    {
        if (other.CompareTag("Grate"))
        {
            _juiceDrippingParticles.Stop();
            _juiceExploParticles.Stop();
